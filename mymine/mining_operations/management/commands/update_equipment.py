        ...
        equipment_data = [
            {
                ...
                'last_service_date': datetime.strptime('2024-11-15', '%Y-%m-%d').date(),
                'next_service_date': datetime.strptime('2024-12-15', '%Y-%m-%d').date(),
            ...
            },
            {
                ...
                'last_service_date': datetime.strptime('2024-12-12', '%Y-%m-%d').date(),
                'next_service_date': datetime.strptime('2025-01-11', '%Y-%m-%d').date(),
                'service_interval_days': 30
            },
            {
                ...
                'last_service_date': datetime.strptime('2024-12-08', '%Y-%m-%d').date(),
                'next_service_date': datetime.strptime('2025-01-22', '%Y-%m-%d').date(),
            ...
            },
            {
                ...
                'last_service_date': datetime.strptime('2024-12-18', '%Y-%m-%d').date(),
                'next_service_date': datetime.strptime('2025-02-01', '%Y-%m-%d').date(),
                'service_interval_days': 45
            },
            {
                ...
                'last_service_date': datetime.strptime('2024-12-15', '%Y-%m-%d').date(),
                'next_service_date': datetime.strptime('2025-01-29', '%Y-%m-%d').date(),
                'service_interval_days': 45
            },
            {
                ...
                'value_usd': 850000.00,
                'last_service_date': datetime.strptime('2024-12-01', '%Y-%m-%d').date(),
                'next_service_date': datetime.strptime('2025-03-01', '%Y-%m-%d').date(),
            ...
            },
            {
                ...
                'last_service_date': datetime.strptime('2024-12-20', '%Y-%m-%d').date(),
                'next_service_date': datetime.strptime('2025-01-19', '%Y-%m-%d').date(),
                'service_interval_days': 30
            },
            {
                'name': 'Ball Mill',
                ...
                'last_service_date': datetime.strptime('2024-12-05', '%Y-%m-%d').date(),
                'next_service_date': datetime.strptime('2025-02-03', '%Y-%m-%d').date(),
