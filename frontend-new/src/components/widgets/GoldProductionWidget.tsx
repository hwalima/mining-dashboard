...
const GoldProductionWidget: React.FC = () => {
  ...
  if (error || !data) {
    return (
      <Paper sx={glassEffect}>
        <Box sx={{ p: 3 }}>
          <Alert severity="error">Failed to load gold production data</Alert>
        </Box>
      </Paper>
    );
  }
        ...
        <Grid item xs={12} sm={2.4}>
          <Card sx={metricCardStyle}>
            <CardContent sx={{
              ...
              <Typography variant="h6">{formatMetricValue(summary.avg_efficiency, 'efficiency')}</Typography>
            </CardContent>
          </Card>
        </Grid>
        <Grid item xs={12} sm={2.4}>
          <Card sx={metricCardStyle}>
            <CardContent sx={{
              ...
              <Typography variant="h6">{formatMetricValue(summary.avg_recovery_rate, 'rate')}</Typography>
            </CardContent>
          </Card>
        </Grid>
        <Grid item xs={12} sm={2.4}>
          <Card sx={metricCardStyle}>
            <CardContent sx={{
              ...
              <Typography variant="h6">{formatMetricValue(summary.avg_gold_price, 'price')}</Typography>
            </CardContent>
          </Card>
        </Grid>
        <Grid item xs={12} sm={2.4}>
          <Card sx={metricCardStyle}>
            <CardContent sx={{
              ...
              <Typography variant="h6">{formatMetricValue(summary.total_smelted_gold, 'smelted')}</Typography>
            </CardContent>
          </Card>
        </Grid>
        <Grid item xs={12} sm={2.4}>
          <Card sx={metricCardStyle}>
            <CardContent sx={{
              ...
              <Typography variant="h6">{formatMetricValue(summary.total_gross_profit, 'profit')}</Typography>
            </CardContent>
          </Card>
        </Grid>
      </Grid>
